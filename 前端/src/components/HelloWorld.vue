            ...
            if (that.verifyCode === that.formItem.code) {
              that.$http.post(that.GLOBAL.serverPath + '/excise/login',
                ...
                if (res.data.result === 'yes') {
                  ...
                  window.localStorage.setItem('name', res.data.loginUser.name)
                  window.localStorage.setItem('sex', res.data.loginUser.sex)
                  window.localStorage.setItem('phone', res.data.loginUser.phone)
                  window.localStorage.setItem('email', res.data.loginUser.email)
                  window.localStorage.setItem('time', res.data.loginUser
                    .time)
